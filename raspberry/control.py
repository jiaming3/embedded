...
# this code is to make connect between sensor data and motor function, where input is
# sensor data and output specific motor function
...
# to ensure the angle direction back to initial state when the smart flower pot move forward and backward
...
def func_sensor(t,hu,p,counter,max_num,move_time,stabilizer,current_rotate_position,rotate_time,temp_threshold,pressure_threshold,humid_threshold):
    ...
    # set if statement for if sensor exist threshold value, then move backward
    unmove = True
...
# function for smart flower pot to return to its inital state
